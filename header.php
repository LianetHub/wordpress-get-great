...
<head>
    ...
    <?php wp_head(); ?>
     ...
     <!-- Telegram Widget --> <script>(function () { var widget = document.createElement('script'); widget.defer = true; widget.dataset.pfId = '0a6c7d99-57ac-4795-848c-7e81843237f7'; widget.src = 'https://widget.yourgood.app/script/widget.js?id=0a6c7d99-57ac-4795-848c-7e81843237f7&now='+Date.now(); document.head.appendChild(widget); })()</script> <!-- /Telegram Widget -->
</head>
